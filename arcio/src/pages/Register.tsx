          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3 pt-1">
              <button
                ...
                className={`w-4 h-4 rounded flex-shrink-0 mt-0.5 border transition-all duration-150 flex items-center justify-center ${
                  agreed ? "bg-stone-900 border-stone-900 text-white" : "border-stone-300 bg-white"
                }`}
              >
                {agreed && <CheckIcon />}
              </button>
